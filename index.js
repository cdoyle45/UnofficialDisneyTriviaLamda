...
var APP_ID = "amzn1.ask.skill.57db402e-5eda-4996-a98f-00171e7bd942";
 ...
 var languageString = {
     "en": {
         "translation": {
             ...
             "GAME_NAME" : "Unofficial Disney Trivia Game",
    ...
    "en-US": {
        "translation": {
            "QUESTIONS" : questions["QUESTIONS_EN_US"],
            "GAME_NAME" : "Unofficial Disney Trivia" // Be sure to change this for your skill.
        }
    },
    "en-GB": {
        "translation": {
...
function handleUserGuess(userGaveUp) {
    ...
    if (answerSlotValid && parseInt(this.event.request.intent.slots.Answer.value) == this.attributes["correctAnswerIndex"]) {
        currentScore++;
        speechOutputAnalysis = getSpeechCon(true);
    } else {
        if (!userGaveUp) {
            speechOutputAnalysis = getSpeechCon(false);
        }
